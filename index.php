...
if(isset($data['feedback_submit'])) {
  if(empty($data['security'])) {
    ...
    if(empty($warnings)) {
        ...
        $to = "kisko@live.com"; // Почта для принимания обратной связи
...
>
  ...
  <div class="container">
	...
	<div class="modal" data-selector="modal-success">
	<div class="modal__content" data-selector="modal-content">
		<svg data-selector="close-success-modal" class="modal__close" width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M12.9957 0.154785C6.32162 0.154785 0.891724 5.58468 0.891724 12.2587C0.891724 18.9327 6.32162 24.3626 12.9957 24.3626C19.6697 24.3626 25.0996 18.9327 25.0996 12.2587C25.0996 5.58468 19.6697 0.154785 12.9957 0.154785ZM17.3781 15.3248C17.4682 15.4104 17.5402 15.5132 17.59 15.6271C17.6397 15.741 17.6662 15.8637 17.6678 15.9879C17.6694 16.1122 17.6461 16.2355 17.5993 16.3506C17.5524 16.4658 17.483 16.5703 17.3952 16.6582C17.3073 16.7461 17.2027 16.8155 17.0876 16.8623C16.9725 16.9091 16.8491 16.9324 16.7249 16.9308C16.6006 16.9293 16.4779 16.9028 16.364 16.8531C16.2502 16.8033 16.1474 16.7312 16.0618 16.6411L12.9957 13.5756L9.92952 16.6411C9.75349 16.8084 9.51909 16.9002 9.2763 16.8971C9.03351 16.894 8.80155 16.7962 8.62986 16.6245C8.45816 16.4528 8.36034 16.2209 8.35723 15.9781C8.35412 15.7353 8.44598 15.5009 8.61322 15.3248L11.6788 12.2587L8.61322 9.19258C8.44598 9.01655 8.35412 8.78215 8.35723 8.53936C8.36034 8.29658 8.45816 8.06461 8.62986 7.89292C8.80155 7.72123 9.03351 7.6234 9.2763 7.62029C9.51909 7.61718 9.75349 7.70904 9.92952 7.87628L12.9957 10.9418L16.0618 7.87628C16.2378 7.70904 16.4722 7.61718 16.715 7.62029C16.9578 7.6234 17.1898 7.72123 17.3614 7.89292C17.5331 8.06461 17.631 8.29658 17.6341 8.53936C17.6372 8.78215 17.5453 9.01655 17.3781 9.19258L14.3125 12.2587L17.3781 15.3248Z" fill="#C7D7E3"/>
		</svg>
		...
		<div class="modal__text">
			...
			<br>
			Мы обязательно изучим ваше письмо и ответим в ближайшее время.
		</div>
	</div>
</div>
	<div class="modal" data-selector="modal-error">
	<div class="modal__content" data-selector="modal-content">
		<svg class="modal__close" data-selector="close-error-modal" width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M12.9957 0.154785C6.32162 0.154785 0.891724 5.58468 0.891724 12.2587C0.891724 18.9327 6.32162 24.3626 12.9957 24.3626C19.6697 24.3626 25.0996 18.9327 25.0996 12.2587C25.0996 5.58468 19.6697 0.154785 12.9957 0.154785ZM17.3781 15.3248C17.4682 15.4104 17.5402 15.5132 17.59 15.6271C17.6397 15.741 17.6662 15.8637 17.6678 15.9879C17.6694 16.1122 17.6461 16.2355 17.5993 16.3506C17.5524 16.4658 17.483 16.5703 17.3952 16.6582C17.3073 16.7461 17.2027 16.8155 17.0876 16.8623C16.9725 16.9091 16.8491 16.9324 16.7249 16.9308C16.6006 16.9293 16.4779 16.9028 16.364 16.8531C16.2502 16.8033 16.1474 16.7312 16.0618 16.6411L12.9957 13.5756L9.92952 16.6411C9.75349 16.8084 9.51909 16.9002 9.2763 16.8971C9.03351 16.894 8.80155 16.7962 8.62986 16.6245C8.45816 16.4528 8.36034 16.2209 8.35723 15.9781C8.35412 15.7353 8.44598 15.5009 8.61322 15.3248L11.6788 12.2587L8.61322 9.19258C8.44598 9.01655 8.35412 8.78215 8.35723 8.53936C8.36034 8.29658 8.45816 8.06461 8.62986 7.89292C8.80155 7.72123 9.03351 7.6234 9.2763 7.62029C9.51909 7.61718 9.75349 7.70904 9.92952 7.87628L12.9957 10.9418L16.0618 7.87628C16.2378 7.70904 16.4722 7.61718 16.715 7.62029C16.9578 7.6234 17.1898 7.72123 17.3614 7.89292C17.5331 8.06461 17.631 8.29658 17.6341 8.53936C17.6372 8.78215 17.5453 9.01655 17.3781 9.19258L14.3125 12.2587L17.3781 15.3248Z" fill="#C7D7E3"/>
		</svg>
		<div class="modal__title">
			Что-то пошло не так...
		...
		<div class="modal__text">
			Ваше сообщение не было отправлено. Пожалуйста, позвоните нам или напишите на почту.
		</div>
	</div>
</div>
	<footer class="footer">
		...
		<div class="footer__content">
			...
			<div class="footer__right">
				...
				<div class="footer__col _third">
					...
					<a href="/privacy.html#terms" class="footer__link">Условия пользования</a>
					<a href="/privacy.html#policy" class="footer__link">Политика конфиденциальности</a>
				</div>
			</div>
